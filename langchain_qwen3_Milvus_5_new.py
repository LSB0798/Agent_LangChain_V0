"""
这份代码基于 langchain_qwen3_Milvus_4.py 展开，取消了 langchain_qwen3_Milvus_4.py 当中 对于 response，prompt 的 print
INITIAL_RETRIEVAL_K 初始检索数量, 从10提高到100
RERANKER_TOP_K 重排序后返回的相关片段数量, 从3提高到20
"""
import os
import torch
import time
...
class EnhancedRAGSystem:
    def __init__(self, config):
        ...
        # 加载或创建向量数据库
        self.vector_db = self._load_or_create_vector_db(connected_port)
    ...
    def recreate_collection(self):
        ...
        try:
            ...
            # 重新创建集合（会重新加载所有文档）
            self.vector_db = self._load_or_create_vector_db(self.config.MILVUS_PORT)
            print("集合已重新创建，文档已更新")
